...
import AddressDetails from "../create-proposal/blocks/Address";
import IncomeDetails from "../create-proposal/blocks/Income";
import LoanProductDetails from "../create-proposal/blocks/LoanProduct";
...
export default function CreateProposal() {
  ...
  const steps = [
    { title: "Property Identification", fields: ['property_type', 'ownership_type', 'owner_name', 'property_address', 'city', 'state'] },
    { title: "Legal And Registration Details", fields: ['property_registration_no', 'dob', 'legal_owner_document'] },
    { title: "Financial Details", fields: ['appox_market_value', 'valuation_report', 'emi_amount'] },
    { title: "Documents", fields: ['productType', 'purpose', 'loanAmount'] }
  ];
    ...
    <Container>
      ...
      <CardContent>
        <Tabs value={currentStep.toString()}>
          <TabsList className="gap-4 flex flex-wrap w-fit mb-4">
            {steps.map((_, index) => (
              <TabsTrigger
                key={index}
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 ">
              ...
              <TabsContent value="0">
                <Card>
                  <CardHeader>
                    <CardTitle>
                      <SubHeading>Property Identification </SubHeading>
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
              ...
              {/* LegalAnd Registration Details */}
              <TabsContent value="1">
                <Card>
                  <CardHeader>
                    <CardTitle>
                      <SubHeading>LegalAnd Registration Details</SubHeading>
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                    <LegalAndRegistrationDetails form={form}/>
                  </CardContent>
                </Card>
              </TabsContent>
              ...
              <TabsContent value="2">
                <Card>
                  <CardHeader>
                    <CardTitle>
                      <SubHeading>Financial Details</SubHeading>
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
